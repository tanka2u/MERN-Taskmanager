...
// @dec     Get all tasks (Admin: all, User: only assigned tasks)
// @route   GET /api/tasks/
// @access  Private
...
// @dec     Create a new task (Admin only)
...
const updateTaskChecklist = async (req, res) => {
    try {
        ...
        res.json({ message: "Task Checklist updated", task });
    } catch (error) {
        res.status(500).json({ message: "Server error", error: error.message });
    }
}; //time:1:17:08
...
// @dec     Dashboard Data (User-specific)
